...
namespace API_Cliente.Controllers
{
    ...
    {
        private readonly API_ClienteContext _context;

        public ClientesController(API_ClienteContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Cliente>> PostCliente(Cliente cliente)
        {
          if (_context.Cliente == null)
          {
              return Problem("Entity set 'API_ClienteContext.Cliente'  is null.");
          }
