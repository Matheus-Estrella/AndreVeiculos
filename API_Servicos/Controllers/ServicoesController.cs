...
namespace API_Servicos.Controllers
{
    ...
    {
        private readonly API_ServicosContext _context;

        public ServicoesController(API_ServicosContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Servico>> PostServico(Servico servico)
        {
          if (_context.Servico == null)
          {
              return Problem("Entity set 'API_ServicosContext.Servico'  is null.");
          }
