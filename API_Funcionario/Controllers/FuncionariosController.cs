...
namespace API_Funcionario.Controllers
{
    ...
    {
        private readonly API_FuncionarioContext _context;

        public FuncionariosController(API_FuncionarioContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Funcionario>> PostFuncionario(Funcionario funcionario)
        {
          if (_context.Funcionario == null)
          {
              return Problem("Entity set 'API_FuncionarioContext.Funcionario'  is null.");
          }
