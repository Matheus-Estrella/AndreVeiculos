...
namespace API_Compra.Controllers
{
    ...
    {
        private readonly API_CompraContext _context;

        public ComprasController(API_CompraContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Compra>> PostCompra(Compra compra)
        {
          if (_context.Compra == null)
          {
              return Problem("Entity set 'API_CompraContext.Compra'  is null.");
          }
